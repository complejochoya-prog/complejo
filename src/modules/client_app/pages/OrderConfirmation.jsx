...
import { CheckCircle2, Home, Utensils, MessageSquare } from 'lucide-react';
                        ...
                        <div className="space-y-4">
                            ...
                            {order.items.map((item, i) => (
                                <div key={i} className="flex justify-between items-start">
                                    ...
                                    <span className="text-sm font-black text-white">${(item.precio * item.quantity).toLocaleString()}</span>
                                </div>
                            ))}
                        </div>
